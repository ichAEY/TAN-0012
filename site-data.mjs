...
export default {
  ...
  "reviews": [
    {
      "author": "Пользователь Яндекс Карт",
      "text": "Аккуратный маникюр без порезов, крепкое покрытие, большой выбор разных покрытий."
    },
    {
      "author": "Ольга Гордеева",
      "text": "Носка месяц и больше без сколов и трещин."
    },
    {
      "author": "Алла Э.",
      "text": "Наталья — самый лучший мастер! Хожу несколько лет только к ней."
    }
  ],
  "promotions": [],
  "amenities": [],
